    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLocationCallback = new LocationCallback()
        {
            public void onLocationResult(LocationResult locationResult)
            {
                if (mTrackingLocation)
                {
                    new DapatkanAlamatTask(Main4Activity.this,
                            Main4Activity.this).execute(locationResult.getLastLocation());
                }
            }
        };
...
//            Log.d("GETPERMISI","getLocation:permissions granded");
                    ...
                    new OnSuccessListener<Location>() {
                        ...
                        public void onSuccess(Location location) {
                            if (location !=null){
                                ...
                                new DapatkanAlamatTask(Main4Activity.this,
                                        Main4Activity.this).execute(location);
                            }else {
    ...
    private void mulaiTrackingLokasi()
    {
        ...
        else
        {
            ...
            mLocationButton.setText("Stop Pencarian Lokasi !");
            mRotateAnim.start();
        }
    }
    private void stopTrackingLokasi()
    {
        if (mTrackingLocation)
        {
            ...
            mLocationButton.setText("Lokasi Meme Saat Ini !");
            mLocationTextView.setText("Lokasi Telah Dihentikan ");
            mRotateAnim.end();
        }
    }
        ...
        switch (requestCode){
            case REQUEST_LOCATION_PERMISSION:
                if (grantResults.length > 0
                    ...
                    Toast.makeText(this," permissions gak dapet masbro, cobalagi",Toast.LENGTH_SHORT).show();
                }
                break;
        }
    }
