...
public class Resep {
    ...
    public static final Resep[] resepmeme = {
            ...
            new Resep("Derp & Derpina", "Derp adalah seorang laki-laki yang memiliki karakter bodoh dalam meme. Dia sering sekali melakukan aktivitas-aktivitas bodoh. Dia juga memiliki pasangan bernama Derpina. Sekilas, jika dilihat mata Derp & Derpina terlihat juling. di Amerika, mata yang juling biasa digunakan untuk melambangkan orang yang bodoh.","Rating : 9/10", R.drawable.derp ),
            new Resep("Herp", "Herp, ini dia karakter yang bisa dibilang menggemaskan dan suka bikin jengkel. Dan ini juga karakter yang bodohnya sangat melebihi si Derp dan Derpina. Dalam meme, dia selalu membuat pernyataan bodoh dan bikin kesal.","Rating : 8/10", R.drawable.herp ),
            new Resep("Bitch Please", "B*tch Please arti gaulnya di Indonesia adalah “please deh yaa”, ya maksudnya kalau seandainya pembuat komik ingin protes ke ilustrasi gambar yang ia tampilkan. Muka b*tch please didapat dari wajah mantan atlet basket dari tim Houston Rockets, Yao Ming.","Rating : 8/10", R.drawable.bitchpls ),
